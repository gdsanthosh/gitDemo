		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Git demo - with commands",
									"targetURL": "#comkiewitgitdemo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comkiewitgitdemo-display": {
								"semanticObject": "comkiewitgitdemo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.kiewit.gitdemo",
									"url": sap.ui.require.toUrl("com/kiewit/gitdemo")
								}
							}
						}
					}
